      ...
      <div className="container max-w-7xl mx-auto px-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="text-xs sm:text-sm leading-relaxed text-muted-foreground space-y-2.5 max-w-xl">
              ...
              <p>Disclaimer: Trader’s Community is not registered with SEBI. All content is shared for educational purposes only and should not be considered investment advice.</p>
            </div>
          ...
          {/* Right Column: Social Links & Disclaimer */}
          <div className="flex flex-col md:items-end justify-between gap-6">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-foreground mb-3 md:text-right">
                Connect With Us
              </p>
            ...
            <div className="text-xs text-muted-foreground md:text-right max-w-sm">
              
              <p className="mt-1">All rights reserved © {new Date().getFullYear()} Trader’s Community.</p>
            </div>
          </div>
        </div>
      </div>
