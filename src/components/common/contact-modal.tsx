      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            animate="animate"
            exit="exit"
            className="relative z-10 w-full max-w-lg max-h-[90vh] flex flex-col rounded-2xl border border-border bg-card shadow-2xl text-card-foreground my-auto overflow-hidden"
          >
            {/* Modal Header */}
